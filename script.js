  ...
  if (storedMeanings.length > 0) {
    ...
    storedMeanings.forEach(function (meaning, index) {
      showMyMeanings.innerHTML += `<li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16"  id=${index} height="16" fill="currentColor" class="bi bi-trash3" style="cursor: pointer;"  onclick="deleteAddedMeaning(this.id)" viewBox="0 0 16 16">
